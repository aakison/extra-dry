...
/// <summary>
/// Actions that are used by the Rule Engine to determine how creates and updates should be
/// processed.
/// </summary>
...
public enum RuleAction
{
    ...
    /// <summary>
    /// Any attempt to change a value will raise an exception by the Rule Engine. Values of
