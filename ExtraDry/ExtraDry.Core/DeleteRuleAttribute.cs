...
/// methods are used on an instantiated object. If a action of Expunge is used, the property is not
/// set and the object is removed from the data store. If no property is specified, the only valid
/// action is Expunge. If a property is specified, the action can be Expunge or Recycle.
/// </summary>
...
public class DeleteRuleAttribute : Attribute
{
    ...
    /// <summary>
    /// The delete rule supports recycling to a soft-delete state and has a valid value for
    /// undeleting.
    /// </summary>
