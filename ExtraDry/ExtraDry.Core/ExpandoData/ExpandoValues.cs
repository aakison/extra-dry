...
/// <summary>
/// Represents values stored as part of expansion data which can optionally be validated against an
/// Expando Schema.
/// </summary>
...
public class ExpandoValues : Dictionary<string, object?>, IValidatableObject
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="ExpandoValues" /> class that uses the
