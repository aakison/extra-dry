...
/// <summary>
/// Represents an exception for an argument that is provided twice and doesn't match.
/// In particular, use when controller gets both URI and body versions of an ID.
/// </summary>
[Serializable]
