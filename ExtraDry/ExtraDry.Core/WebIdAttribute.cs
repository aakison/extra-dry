...
/// <summary>
/// Validates that a string field is a valid WebId, allowing it to be part of a URI path without
/// translation. This only allows letters, numbers, and the punctuation "-", "_", ".", and "~".
/// </summary>
public class WebIdAttribute : RegularExpressionAttribute
{
    ...
    /// </summary>
    /// <remarks>
    /// Limits to 100 characters, but _should_ be smaller, also use with MaxLength the ensure
    /// smaller size.
    /// </remarks>
