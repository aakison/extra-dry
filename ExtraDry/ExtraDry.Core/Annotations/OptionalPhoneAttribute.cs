...
/// <summary>
/// Validates that a string property contains a valid phone number, but passes validation when the
/// value is absent (null or empty string).
/// </summary>
/// <remarks>
/// The BCL <see cref="PhoneAttribute"/> predates C# nullable reference types. It correctly
...
{
    /// <inheritdoc cref="OptionalPhoneAttribute" />
    ...
    public override bool IsValid(object? value) =>
        value is null or "" || _phone.IsValid(value);

    private static readonly PhoneAttribute _phone = new();
}
