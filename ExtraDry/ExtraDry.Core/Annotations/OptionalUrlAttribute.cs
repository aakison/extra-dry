...
/// <summary>
/// Validates that a string property contains a valid URL, but passes validation when the
/// value is absent (null or empty string).
/// </summary>
/// <remarks>
/// The BCL <see cref="UrlAttribute"/> predates C# nullable reference types. It correctly
...
public class OptionalUrlAttribute : ValidationAttribute
{
    ...
    public override bool IsValid(object? value) =>
        value is null or "" || _url.IsValid(value);

    private static readonly UrlAttribute _url = new();
}
