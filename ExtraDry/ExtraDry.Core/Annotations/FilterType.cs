...
/// <summary>
/// The processing rule to be applied to a property when a <see cref="FilterQuery" /> or
...
public enum FilterType
{
    ...
    /// <summary>
    /// If the property is a `string`, then the filter matches when the text occurs anywhere within
    /// the property.
    /// </summary>
    Contains,
}
