...
public interface IBlob : IResourceIdentifiers {
    ...
    /// <summary>
    /// The MIME Type (aka Content-Type) of the Blob.  This is declared when the Blob is created, 
    /// no attempt to dynamically determine the type is made.  
    /// </summary>
    string MimeType { get; set; }

    /// <summary>
    /// The optional MD5 hash of the content of the Blob.  This is used to verify the integrity of
    /// files during upload and download.  If the hash is not provided, the integrity of the file 
    /// is not checked.
    /// </summary>
