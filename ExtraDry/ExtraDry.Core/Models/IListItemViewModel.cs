...
/// <summary>
/// Represents the interface that defines the display titles for list items. Models can implement
/// this or ViewModel objects can implement this for models. Consider IListItemViewModel`TModel
/// instead to use a ViewModel controller.
/// </summary>
public interface IListItemViewModel
{
    ...
    /// <summary>
    /// A Description for the subject to elaborate on details, may also be considered for markdown
    /// support.
    /// </summary>
