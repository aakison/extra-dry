...
/// <summary>
/// Represents an entity that supports a hierarchy of values using the Lineage pattern. This
/// provides most of the desire functionality for a hierarchy, but does not provide the ability to
/// navigate the hierarchy. Use <see cref="IHierarchyEntity{T}" /> for full functionality.
/// </summary>
