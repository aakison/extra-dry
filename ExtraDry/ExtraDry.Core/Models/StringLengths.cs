...
/// interoperability and consistency across multiple services. Lengths are given semenatic meaning
/// to facilitate understanding and consistency across the system. Additionally, they are used to
/// inform form layout when using multiple columns.
/// </summary>
public static class StringLength
{
    ...
    /// <summary>
    /// Represents a short phrase or claus, such as a caption. Receives a medium form field
    /// element, e.g. half of a page width.
    /// </summary>
    ...
    /// <summary>
    /// Represents enough space for an extremely long, but not unlimited amount of text. Receives a
    /// multi-line field element.
    /// </summary>
