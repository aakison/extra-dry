...
/// more consumable for applications that host users.  While, if this functionality is not 
/// required, an Expunge action creates an API that is simpler to implement.  Expunge actions can also
/// be applied to specific entities that might have regulatory requirements for deletion.
/// </summary>
