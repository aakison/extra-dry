...
public class EnumDimension
{
    ...
    /// <summary>
    /// The Name property from the Display attributes if they exist, or a title-cased version of
    ...
    /// <summary>
    /// The Description from the Display attributes. If no descriptions, this will be ignored on
    /// build.
    /// </summary>
    [StringLength(1000)]
    ...
    /// <summary>
    /// The ShortName from the Display attributes. If no short names, this will be ignored on
    /// build.
    /// </summary>
    [StringLength(50)]
    ...
    /// <summary>
    /// The GroupName from the Display attributes. If no group names, this will be ignored on
    /// build.
    /// </summary>
    [StringLength(50)]
