...
/// <summary>
/// Options for configuring the <see cref="RevisionAspect"/>.  Use with the 
/// <see cref="ServiceCollectionExtensions.AddRevisionAspect(IServiceCollection, Action{RevisionAspectOptions})"/>
