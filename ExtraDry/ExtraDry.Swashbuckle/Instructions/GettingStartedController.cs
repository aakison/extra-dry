...
/// make service access layers for application.
///
...
///   * Read in through a code generator like AutoRest to generate a client-side service 
///     access layer.
/// 
...
/// link to the OpenAPI specification document (e.g. [/swagger/reference-codes/swagger.json])
///
/// ### RESTful Design
...
///   * Endpoints that act on individual or collective resources as entities (not remote 
///     procedure calls)
...
/// example, if this all feels too much, why not start with this affirmation:
/// </summary>
[ApiController]
