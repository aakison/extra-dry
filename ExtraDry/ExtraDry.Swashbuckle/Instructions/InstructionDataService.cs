    ...
    private static List<Animal> Animals {
        get {
            var animals = new List<Animal>() {
                ...
                new Animal { Lineage = HierarchyId.Parse("/1/"), Title = "Vertebrates", Uuid = Guid.Parse("0d3a53a7-31b8-4b1d-b4d6-49c5a3e6e3b6") },
                new Animal { Lineage = HierarchyId.Parse("/1/1/"), Title = "Mammals", Uuid = Guid.Parse("c2ab8a87-5f08-4097-a6aa-4bfbf6e2c1d7") },
                new Animal { Lineage = HierarchyId.Parse("/1/1/1/"), Title = "Human", Description = "A bipedal primate belonging to the species Homo sapiens, known for its advanced cognitive abilities and civilizations.", Uuid = Guid.Parse("0de2c3a4-5762-4f4d-9cd9-5e5f6e7f8e9f")},
                new Animal { Lineage = HierarchyId.Parse("/1/1/2/"), Title = "Dolphin", Description = "A highly intelligent aquatic mammal known for its playful behavior and use of complex vocalizations.", Uuid = Guid.Parse("92e4e8d1-d9a2-4e4b-8f8d-ea1f99a2a8e1") },
                new Animal { Lineage = HierarchyId.Parse("/1/1/3/"), Title = "Elephant", Description = "A large herbivorous mammal with a trunk, long tusks, and flapping ears, native to Africa and Asia.", Uuid = Guid.Parse("b195fabc-6a67-41d6-ae5b-3a1eb1a3c1a2") },
                new Animal { Lineage = HierarchyId.Parse("/1/2/"), Title = "Birds", Uuid = Guid.Parse("e58a2a8c-8c32-4b8b-8e02-f9a3ee4a5c6f") },
                new Animal { Lineage = HierarchyId.Parse("/1/2/1/"), Title = "Sparrow", Description = "A small, often brown - colored bird known for its melodious songs and wide distribution across the world.", Uuid = Guid.Parse("5f217c3b-9d3c-4e19-b079-1d3b1c9e4f2b") },
                new Animal { Lineage = HierarchyId.Parse("/1/2/2/"), Title = "Eagle", Description = "A large bird of prey with a powerful build, keen eyesight, and the ability to fly at high altitudes.", Uuid = Guid.Parse("7d19ea1b-ee5b-4b2b-bd7d-f650e7e4b9b2")},
                new Animal { Lineage = HierarchyId.Parse("/1/2/3/"), Title = "Penguin", Description = "A flightless bird adapted for life in the water with a streamlined body and flippers for swimming.", Uuid = Guid.Parse("b7388bda-6f7e-4fcb-89ef-ec1a3da56b25") },
                new Animal { Lineage = HierarchyId.Parse("/1/3/"), Title = "Fish", Uuid = Guid.Parse("2fc1f5ae-7b35-460a-9dac-91bcfcf2b991") },
                new Animal { Lineage = HierarchyId.Parse("/1/3/1/"), Title = "Salmon", Description = "An anadromous fish known for its incredible migrations from freshwater to saltwater and back for spawning.", Uuid = Guid.Parse("4de4db5c-4b9d-4f60-9b86-f1f1a6e1ee28") },
                new Animal { Lineage = HierarchyId.Parse("/1/3/2/"), Title = "Shark", Description = "A powerful predatory fish with a streamlined body, cartilaginous skeleton, and multiple rows of sharp teeth.", Uuid = Guid.Parse("52a3bbd8-2f5f-4a76-9f64-7522b4b2f1a7") },
                new Animal { Lineage = HierarchyId.Parse("/1/3/3/"), Title = "Clownfish", Description = "A brightly colored fish known for its symbiotic relationship with sea anemones.", Uuid = Guid.Parse("d5d2d69d-7891-47a2-bbc9-ae28b55614b4") },
                new Animal { Lineage = HierarchyId.Parse("/1/4/"), Title = "Amphibians", Uuid = Guid.Parse("3b8fd845-5717-486e-9f5d-52c214a2a8b3") },
                new Animal { Lineage = HierarchyId.Parse("/1/4/1/"), Title = "Frog", Description = "A small amphibian with smooth skin, strong legs for jumping, and a life cycle that includes both aquatic and terrestrial stages.", Uuid = Guid.Parse("fbe4b5ac-4f0b-41ea-9dcb-e9c9d8f7c2f3") },
                new Animal { Lineage = HierarchyId.Parse("/1/4/2/"), Title = "Salamander", Description = "A slender amphibian that resembles a lizard and often has an aquatic larval stage.", Uuid = Guid.Parse("9b9f4823-9d60-4b7a-9285-557f6963a4a4") },
                new Animal { Lineage = HierarchyId.Parse("/1/5/"), Title = "Reptiles", Uuid = Guid.Parse("cda23b3b-9823-4b1f-8f8b-a1d9c7c390f1") },
                new Animal { Lineage = HierarchyId.Parse("/1/5/1/"), Title = "Crocodile", Description = "A large predatory reptile with a powerful jaw, long tail, and armored skin, typically found in freshwater habitats.", Uuid = Guid.Parse("74e5678e-e90c-47d3-8c65-8574f5b3a9f2") },
                new Animal { Lineage = HierarchyId.Parse("/1/5/2/"), Title = "Turtle", Description = "A reptile with a bony or cartilaginous shell protecting its body, both in water and on land.", Uuid = Guid.Parse("516f25d6-8b3f-4bbc-bc4a-9c6dfd75a177") },
                new Animal { Lineage = HierarchyId.Parse("/1/5/3/"), Title = "Snake", Description = "A legless reptile with a long, flexible body and scales, some of which are venomous.", Uuid = Guid.Parse("b4e4fce4-8eac-4e5a-85ea-d3abd56fd07f") },
                new Animal { Lineage = HierarchyId.Parse("/2/"), Title = "Invertebrates", Uuid = Guid.Parse("1131fd2c-36d7-4e25-abb1-393b1a5d8f41") },
                new Animal { Lineage = HierarchyId.Parse("/2/1/"), Title = "Arthropods", Uuid = Guid.Parse("85aad67a-ceda-4b97-afe7-3b3901b8c8eb") },
                new Animal { Lineage = HierarchyId.Parse("/2/1/1/"), Title = "Insects", Uuid = Guid.Parse("195f8b9a-ffcd-486b-932b-5ea1f8c0dd2f") },
                new Animal { Lineage = HierarchyId.Parse("/2/1/1/1/"), Title = "Ant", Description = "A small, social insect known for its organized colonies, strength relative to size, and ability to work collectively.", Uuid = Guid.Parse("f3265afa-b23b-4cb8-94be-df635e4eaf2f") },
                new Animal { Lineage = HierarchyId.Parse("/2/1/1/2/"), Title = "Butterfly", Description = " A colorful, winged insect that undergoes a metamorphic life cycle starting from a caterpillar to a pupa and finally an adult.", Uuid = Guid.Parse("e50b1c78-3c8f-44a9-bf3e-e1f9582c9e66") },
                new Animal { Lineage = HierarchyId.Parse("/2/1/1/3/"), Title = "Bee", Description = "A flying insect known for its role in pollination and its ability to produce honey in complex social colonies.", Uuid = Guid.Parse("a1848ad7-2b1e-4f3e-b17f-f9b5f4a60f02") },
                new Animal { Lineage = HierarchyId.Parse("/2/1/2/"), Title = "Arachnids", Uuid = Guid.Parse("2e5b596f-98a4-4f7a-8d2e-91b9ebe2e956") },
                new Animal { Lineage = HierarchyId.Parse("/2/1/2/1/"), Title = "Spider", Description = "An eight - legged arthropod known for spinning silk webs to catch its prey.", Uuid = Guid.Parse("48d407a7-fd38-467b-9b68-5e3dd89b6f0a") },
                new Animal { Lineage = HierarchyId.Parse("/2/1/2/2/"), Title = "Scorpion", Description = "An arthropod with a segmented tail tipped with a venomous stinger, primarily found in desert habitats.", Uuid = Guid.Parse("5e2fd632-47a1-4a80-ae47-d1a3a9fde5c2") },
                new Animal { Lineage = HierarchyId.Parse("/2/2/"), Title = "Mollusks", Uuid = Guid.Parse("e24b6d65-dbb0-4f7b-9b9d-ee5fcef0c8ae") },
                new Animal { Lineage = HierarchyId.Parse("/2/2/1/"), Title = "Snail", Description = "A slow - moving mollusk with a coiled shell, known for its secretion of slime.", Uuid = Guid.Parse("3c76e4a5-f91e-4b65-9e22-fefb2c1d1f5a") },
                new Animal { Lineage = HierarchyId.Parse("/2/2/2/"), Title = "Octopus", Description = "A cephalopod mollusk with eight tentacles, known for its intelligence and ability to change color.", Uuid = Guid.Parse("6f23b6e1-cf1e-4d36-bf5b-a7bbe8b3d9e1") },
                new Animal { Lineage = HierarchyId.Parse("/2/2/3/"), Title = "Clam", Description = "A bivalve mollusk with two hinged shells, often buried in sand or mud.", Uuid = Guid.Parse("0bbcee59-07a0-4f4c-92e2-dbb80c7ea1a3") },
                new Animal { Lineage = HierarchyId.Parse("/2/3/"), Title = "Annelids", Uuid = Guid.Parse("84d6c9a1-87ed-4f1b-bdc7-8b8e4f50b3d2") },
                new Animal { Lineage = HierarchyId.Parse("/2/3/1/"), Title = "Earthworm", Description = "A segmented annelid that lives underground and plays a vital role in soil aeration and decomposition.", Uuid = Guid.Parse("7f82bcf3-6d16-4302-ae13-1d3293e64a4f") },
                new Animal { Lineage = HierarchyId.Parse("/2/4/"), Title = "Cnidarians", Uuid = Guid.Parse("6890dfb6-1d34-4b29-a6b5-8cc5e5a69dbf") },
