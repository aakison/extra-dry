...
///
/// The information is provided to assist in some quick answers to common questions. For example,
/// in a ticketing system it would be desirable to show users the count of tickets marked as
/// 'critical'. Or the number of closed tickets in the past 30 days.
///
...
/// ### Types of Statistics
///
/// * *Distribution* - For fields that contain a small set of discrete values, the set of distinct
/// values is returned along with the number of occurrences of that value.
///
/// ### Try It Out Use the endpoint below to retrieve the statistics for the sample database of car
/// make and models - no authentication required.
/// </summary>
[ApiController]
...
public class StatisticsController
{
    ...
    /// </summary>
    /// <param name="query">
    /// The filter to apply to the collection prior to collecting statistics.
    /// </param>
