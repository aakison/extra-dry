...
/// </summary>
/// <remarks>
/// Options for schema are ReadOnly or WriteOnly. Determines if Swagger UI shows values on retrieve
/// (WriteOnly = false), or as available for POST/PUT (ReadOnly = false).
///
