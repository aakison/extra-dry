...
public class ExtraDryGenOptions
{
    ...
    {
        /// <summary>
        /// The signature of endpoints will generate status codes. E.g. Authorize attribute implies
        /// status code of 503 Forbidden is valid.
        /// </summary>
        ...
        /// attribute to control the name and order of Tags in the OpenAPI document. These tags are
        /// used to display names and groups of endpoints in the Swagger UI.
        /// </summary>
