...
public class Blob : IBlob, IValidatableObject, ITenanted
{
    ...
    /// <summary>
    /// If the Blob is an attachment of another Entity, this is the UUID of that Entity.
    /// </summary>
    [HttpHeader(OwnerHeaderName)]
    public Guid OwnerUuid { get; set; } = Guid.Empty;

    /// <summary>
    /// If the Blob is an attachment of another Entity, this is the type of that Entity.
    /// </summary>
    [StringLength(StringLength.Line)]
