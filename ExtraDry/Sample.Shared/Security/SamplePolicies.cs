...
namespace Sample.Shared.Security {
    ...
    public static class SamplePolicies {
        ...
        /// In Blazor: `builder.Services.AddAuthorizationCore(options => SamplePolicies.AddAuthorizationOptions(options));`
        /// In MVC: `services.AddAuthorization(options => SamplePolicies.AddAuthorizationOptions(options));`
        /// </summary>
        ...
        /// <summary>
        /// A sample policy constant to be used when defining authorization rules on endpoints.
        /// E.g. use `[Authorize(SamplePolicies.SamplePolicy)]` instead of `[Authorize("SamplePolicy")]`.
        /// </summary>
