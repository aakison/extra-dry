...
public class TimeIntervalTests
{
    ...
    [Theory]
    [InlineData("", "2024-02-29", "Created:[,2024-2-29]")]
    [InlineData("2024-02-29", "", "Created:[2024-2-29,]")]
    [InlineData("", "", "")]
    ...
    [Theory]
    [InlineData("Created:[,2024-2-29]", "Before 29 Feb 2024")]
    [InlineData("Created:[2024-2-29,]", "After 29 Feb 2024")]
    ...
    [InlineData(0, 1, "Feb 27")]
    [InlineData(0, 2, "Feb 26")]
    [InlineData(0, 3, "Feb 25")]
    [InlineData(-1, 1, "Feb 26")]
    [InlineData(-1, 2, "Feb 25")]
    [InlineData(-1, 3, "Feb 24")]
    [InlineData(-2, 0, "Feb 26-27")]
    [InlineData(-7, 1, "Feb 14-20")]
    [InlineData(-7, 2, "Feb 7-13")]
    [InlineData(-7, 3, "Jan 31-Feb 6")]
    [InlineData(-30, 1, "Dec 30-Jan 28")]
    [InlineData(-30, 2, "Nov 30-Dec 29")]
    [InlineData(-30, 3, "Oct 31-Nov 29")]
    public void DayIntervalPrevious(int day, int offset, string expectedDescription)
    {
        var timeInterval = new TestableTimeInterval(TimeIntervalType.Days, day, day.ToString(CultureInfo.InvariantCulture));
    ...
    [Theory]
    [InlineData(0, 3, "Mar 2")]
    [InlineData(0, 2, "Mar 1")]
    [InlineData(0, 1, "Feb 29")]
    [InlineData(0, 0, "Today")]
    [InlineData(-1, 3, "Mar 1")]
    [InlineData(-1, 2, "Feb 29")]
    [InlineData(-1, 1, "Today")]
    [InlineData(-2, 0, "Feb 26-27")]
    [InlineData(-7, 3, "Mar 13-19")]
    [InlineData(-7, 2, "Mar 6-12")]
    [InlineData(-7, 1, "Feb 28-Mar 5")]
    [InlineData(-30, 3, "Apr 28-May 27")]
    [InlineData(-30, 2, "Mar 29-Apr 27")]
    [InlineData(-30, 1, "Feb 28-Mar 28")]
    public void DayIntervalNext(int day, int offset, string expectedDescription)
    {
        var timeInterval = new TestableTimeInterval(TimeIntervalType.Days, day, day.ToString(CultureInfo.InvariantCulture));
    ...
    [Theory]
    [InlineData(0, 0, "Created:[2024-2-28,2024-2-28]")]
    [InlineData(0, 1, "Created:[2024-2-29,2024-2-29]")]
    [InlineData(0, -1, "Created:[2024-2-27,2024-2-27]")]
    [InlineData(-1, 0, "Created:[2024-2-27,2024-2-27]")]
    [InlineData(-1, 1, "Created:[2024-2-28,2024-2-28]")]
    [InlineData(-1, -1, "Created:[2024-2-26,2024-2-26]")]
    [InlineData(-2, 0, "Created:[2024-2-26,2024-2-27]")]
    [InlineData(-7, 0, "Created:[2024-2-21,2024-2-27]")]
    [InlineData(-7, 1, "Created:[2024-2-28,2024-3-5]")]
    [InlineData(-7, -1, "Created:[2024-2-14,2024-2-20]")]
    [InlineData(-30, 0, "Created:[2024-1-29,2024-2-27]")]
    [InlineData(-30, 1, "Created:[2024-2-28,2024-3-28]")]
    [InlineData(-30, -1, "Created:[2023-12-30,2024-1-28]")]
    ...
    [Theory]
    [InlineData("Created:[2024-2-28,2024-2-28]", 0, "Today")]
    [InlineData("Created:[2024-2-29,2024-2-29]", 0, "Feb 29")]
    [InlineData("Created:[2024-2-27,2024-2-27]", 0, "Feb 27")]
    [InlineData("Created:[2024-2-26,2024-2-26]", 0, "Feb 26")]
    [InlineData("Created:[2024-2-26,2024-2-27]", -2, "Feb 26-27")]
    [InlineData("Created:[2024-2-21,2024-2-27]", -7, "Feb 21-27")]
    [InlineData("Created:[2024-2-28,2024-3-5]", -7, "Feb 28-Mar 5")]
    [InlineData("Created:[2024-2-14,2024-2-20]", -7, "Feb 14-20")]
    [InlineData("Created:[2024-1-29,2024-2-27]", -30, "Jan 29-Feb 27")]
    [InlineData("Created:[2024-2-28,2024-3-28]", -30, "Feb 28-Mar 28")]
    [InlineData("Created:[2023-12-30,2024-1-28]", -30, "Dec 30-Jan 28")]
    ...
    [Theory]
    [InlineData(0, 1, "Jan 2024")]
    [InlineData(0, 2, "Dec 2023")]
    [InlineData(0, 3, "Nov 2023")]
    [InlineData(-1, 1, "Dec 2023")]
    [InlineData(-1, 2, "Nov 2023")]
    [InlineData(-1, 3, "Oct 2023")]
    [InlineData(-3, 1, "Aug-Oct 2023")]
    [InlineData(-3, 2, "May-Jul 2023")]
    [InlineData(-3, 3, "Feb-Apr 2023")]
    [InlineData(-6, 1, "Feb-Jul 2023")]
    [InlineData(-6, 2, "Aug 2022-Jan 2023")]
    [InlineData(-6, 3, "Feb-Jul 2022")]
    [InlineData(-12, 1, "Feb 2022-Jan 2023")]
    [InlineData(-12, 2, "Feb 2021-Jan 2022")]
    [InlineData(-12, 3, "Feb 2020-Jan 2021")]
    public void MonthIntervalPrevious(int month, int offset, string expectedDescription)
    {
        var timeInterval = new TestableTimeInterval(TimeIntervalType.Months, month, month.ToString(CultureInfo.InvariantCulture));
    ...
    [Theory]
    [InlineData(0, 0, "Created:[2024-2,2024-2]")]
    [InlineData(-1, 0, "Created:[2024-1,2024-1]")]
    [InlineData(-2, 0, "Created:[2023-12,2024-1]")]
    [InlineData(-3, 0, "Created:[2023-11,2024-1]")]
    [InlineData(-3, -1, "Created:[2023-8,2023-10]")]
    [InlineData(-6, 0, "Created:[2023-8,2024-1]")]
    [InlineData(-12, 0, "Created:[2023-2,2024-1]")]
    ...
    [Theory]
    [InlineData("Created:[2024-2,2024-2]", 0, "Feb 2024")]
    [InlineData("Created:[2024-1,2024-1]", 0, "Jan 2024")]
    [InlineData("Created:[2023-12,2024-1]", -2, "Dec 2023-Jan 2024")]
    [InlineData("Created:[2023-11,2024-1]", -3, "Nov 2023-Jan 2024")]
    [InlineData("Created:[2023-8,2023-10]", -3, "Aug-Oct 2023")]
    [InlineData("Created:[2023-8,2024-1]", -6, "Aug 2023-Jan 2024")]
    [InlineData("Created:[2023-2,2024-1]", -12, "Feb 2023-Jan 2024")]
    ...
    [Theory]
    [InlineData(0, 1, "Oct-Dec 2023")]
    [InlineData(0, 2, "Jul-Sep 2023")]
    [InlineData(0, 3, "Apr-Jun 2023")]
    [InlineData(0, 4, "Jan-Mar 2023")]
    public void QuarterIntervalPrevious(int quarter, int offset, string expectedDescription)
    {
    ...
    [Theory]
    [InlineData(0, "Created:[2024-1,2024-3]")]
    [InlineData(-1, "Created:[2023-10,2023-12]")]
    [InlineData(-2, "Created:[2023-7,2023-9]")]
    [InlineData(-3, "Created:[2023-4,2023-6]")]
    [InlineData(-4, "Created:[2023-1,2023-3]")]
    ...
    [InlineData(-1, 2, "2021")]
    [InlineData(-1, 3, "2020")]
    [InlineData(-3, 1, "2018-2020")]
    [InlineData(-3, 2, "2015-2017")]
    [InlineData(-3, 3, "2012-2014")]
    public void YearIntervalPrevious(int year, int offset, string expectedDescription)
    {
        var timeInterval = new TestableTimeInterval(TimeIntervalType.Years, year, year.ToString(CultureInfo.InvariantCulture));
    ...
    [Theory]
    [InlineData(0, "Created:[2024,2024]")]
    [InlineData(-1, "Created:[2023,2023]")]
    [InlineData(-2, "Created:[2022,2023]")]
    [InlineData(-3, "Created:[2021,2023]")]
    ...
    [Theory]
    [InlineData("Created:[2024,2024]", 0, "2024")]
    [InlineData("Created:[2023,2023]", 0, "2023")]
    [InlineData("Created:[2022,2023]", -2, "2022-2023")]
    [InlineData("Created:[2021,2023]", -3, "2021-2023")]
