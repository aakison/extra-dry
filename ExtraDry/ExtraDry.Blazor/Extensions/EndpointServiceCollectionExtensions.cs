...
/// </summary>
/// <remarks>
/// AddListClient is defined in ExtrayDry.Blazor while AddCrudClient is defined in ExtraDry.Core.  The list clients
/// also register the list as an IOptionProvider for use with Blazor components.  This is not available in ExtraDry.Core.
/// The same signature for the AddListClient methods is also defined in ExtraDry.Server so that server projects
/// can use list but not use the Blazor specific IOptionProvider.
/// </remarks>
