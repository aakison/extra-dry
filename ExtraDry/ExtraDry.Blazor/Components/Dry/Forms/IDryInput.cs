...
/// <summary>
/// An interface for any component that can be used as a form input.  This includes all the 
/// concrete type components that are composited into the <see cref="IDryInput{T}"/> component.
/// </summary>
...
public interface IDryInput<T> : IExtraDryComponent
{
    ...
    /// which property the component is for and the details about how it is rendered.
    /// </summary>
