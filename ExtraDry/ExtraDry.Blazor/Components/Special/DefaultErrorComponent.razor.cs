...
/// <summary>
/// Displays an error using a consistent display style. Use with DryErrorBoundary to get consistent
/// styling of exceptions across site. To override, use the `Theme` component to register your own
