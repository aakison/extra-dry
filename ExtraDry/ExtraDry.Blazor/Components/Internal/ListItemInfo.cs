...
public class ListItemInfo<TItem>
{
    ...
    /// <summary>
    /// Indicates if the item has been loaded. Used when getting pages of data from the server and
    /// the actual items might be unloaded.
    /// </summary>
    public bool IsLoaded { get; set; }

    /// <summary>
    /// Indicates how far down the grouping this item is. 0 implies not in any group or the head of
    /// a group.
    /// </summary>
