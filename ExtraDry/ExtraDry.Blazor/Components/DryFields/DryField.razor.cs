...
/// </summary>
public partial class DryField<T>
    ...
    where T : class
{
    ...
    /// <inheritdoc cref="DryFieldBase{TModel}.OnInput" />
    [Parameter]
    public EventCallback<ChangeEventArgs> OnInput { get; set; }

    /// <inheritdoc cref="DryFieldBase{TModel}.OnChange" />
    [Parameter]
    public EventCallback<ChangeEventArgs> OnChange { get; set; }

    /// <inheritdoc cref="DryFieldBase{TModel}.OnValidate"/>
    [Parameter]
    ...
    //[Inject]
    //private ILogger<DryField<T>> Logger { get; set; } = null!;
    ...
    private bool IsDateField => Property?.HasDateTimeRepresentation == true;

    private bool IsNumericField => Property?.HasNumericRepresentation == true;

    private bool IsTextField => Property?.HasTextRepresentation == true;

    private bool IsOptionField => Property?.HasReferenceDataTypeRepresentation == true;
}
