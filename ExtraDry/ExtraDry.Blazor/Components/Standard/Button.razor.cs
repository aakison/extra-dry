...
public partial class Button : ComponentBase, IExtraDryComponent
{
    ...
    /// <summary>
    /// Indicates if the visual affordance icon should be shown, independent of the content of the
    /// Affordance property. Default: true.
    /// </summary>
    [Parameter]
    public bool ShowAffordance { get; set; } = true;

    /// <summary>
    /// For advanced rendering options, the button may also take any arbitrary child content. This
    /// content is rendered inside the button along with other content, use the "ShowXxx"
