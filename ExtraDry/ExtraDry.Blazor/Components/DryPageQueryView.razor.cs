...
public partial class DryPageQueryView
{
    ...
    /// will attach to this query builder.  When filters change the components will use this 
    /// query builder to notify other components that an update is required, e.g. for a table 
    /// component to refresh its contents based on the new filter.  Filters will also refresh
