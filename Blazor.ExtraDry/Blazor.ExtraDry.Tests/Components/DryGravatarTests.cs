...
namespace Blazor.ExtraDry.Tests.Components {
    public class DryGravatarTests : IDisposable {

        [Fact]
        public void GravatarHasSurroundingDiv()
        {
            var fragment = context.RenderComponent<DryGravatar>();
        ...
        {
            var fragment = context.RenderComponent<DryGravatar>(("Email", exampleEmail));
        ...
        {
            var fragment = context.RenderComponent<DryGravatar>(("Email", exampleEmail), ("HideEmail", true));
        ...
        {
            var fragment = context.RenderComponent<DryGravatar>(("Email", exampleEmail), ("Size", 123));
